...
exports.TriggeredCommand = void 0;
const decorators_1 = require("@sapphire/decorators");
const framework_1 = require("@sapphire/framework");
const axios_1 = __importDefault(require("axios"));
require('dotenv').config();
let TriggeredCommand = class TriggeredCommand extends framework_1.Command {
    ...
    async messageRun(message) {
        axios_1.default
            ...
            .catch(async (error) => {
            console.error(error);
            return await message.reply('Something went wrong when trying to fetch a triggered gif :(');
        });
    }
...
TriggeredCommand = __decorate([
    (0, decorators_1.ApplyOptions)({
        name: 'triggered',
        description: 'Replies with a random triggered gif!'
    })
], TriggeredCommand);
exports.TriggeredCommand = TriggeredCommand;
