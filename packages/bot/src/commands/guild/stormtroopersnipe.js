...
exports.StormtrooperSnipeCommand = void 0;
...
let StormtrooperSnipeCommand = class StormtrooperSnipeCommand extends framework_1.Command {
    async chatInputRun(interaction) {
        ...
        if (interaction.member.permissions.has('ADMINISTRATOR') || interaction.member.roles.cache.find(r => r.name === 'Sniper' || r.name === 'Enforcer' || r.name === 'Ruby (Lvl. 75+)' || r.name === 'Emerald (Lvl. 60+)' || r.name === 'Sapphire (Lvl. 45+)' || r.name === 'Steel (Lvl. 30+)' || r.name === 'Obsidian (Lvl. 15+)')) {
            ...
            if (sniped.channel instanceof discord_js_1.TextChannel) {
...
StormtrooperSnipeCommand = __decorate([
    (0, decorators_1.ApplyOptions)({
        name: 'stormtroopersnipe',
        description: 'Reveals a recently deleted message from a random channel.'
    })
], StormtrooperSnipeCommand);
exports.StormtrooperSnipeCommand = StormtrooperSnipeCommand;
//# sourceMappingURL=stormtroopersnipe.js.map