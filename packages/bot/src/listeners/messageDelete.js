...
exports.MessageDeleteListener = void 0;
const decorators_1 = require("@sapphire/decorators");
const framework_1 = require("@sapphire/framework");
let MessageDeleteListener = class MessageDeleteListener extends framework_1.Listener {
    async run(message) {
...
MessageDeleteListener = __decorate([
